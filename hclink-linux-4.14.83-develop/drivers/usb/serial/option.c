...
/*add usb-lte support for ZTE*/
#define OPTION_PRODUCT_ZTE_LTE_1476		0x1476
#define OPTION_PRODUCT_ZTE_LTE_1509		0x1509
...
// add EM360 usb serial product id  qinsibo@712.cn 2023.11.29
#define EM350_PRODUCT_E1506 0x1506
#define EM350_PRODUCT_E1C05 0x1C05
#define HUAWEI_PRODUCT_E15C1 0x15C1
#define HUAWEI_PRODUCT_E15C3 0x15C3
...
/* CX630 */
#define CX630_VENDOR_ID                         0x18d1
#define CX630_PRODUCT_ID                        0x181f
...
//Fibocom begin
	...
	/* add USB Device for HUAWEI EM360 LTE Dev ,qinsibo@712.cn 2023.11.29*/
	{ USB_DEVICE(HUAWEI_VENDOR_ID, EM350_PRODUCT_E1506) },
	{ USB_DEVICE(HUAWEI_VENDOR_ID, EM350_PRODUCT_E1C05) },
	{ USB_DEVICE(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_E15C1) },
	{ USB_DEVICE(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_E15C3) },
//Fibocom end	
	...
	{ USB_DEVICE(CX630_VENDOR_ID, CX630_PRODUCT_ID) },
...
#if (LINUX_VERSION_CODE <= KERNEL_VERSION( 3,15,9 ))
	.set_termios       = usb_wwan_set_termios,
#endif
	.tiocmget          = usb_wwan_tiocmget,
	.tiocmset          = usb_wwan_tiocmset,
#if (LINUX_VERSION_CODE <= KERNEL_VERSION( 4,19,60 ))
			...
			const struct usb_device_id *id)
{
	...
	/*lte support --add by liji 20190219*/
	if (serial->dev->descriptor.idVendor == ZTE_VENDOR_ID &&
	serial->dev->descriptor.idProduct == OPTION_PRODUCT_ZTE_LTE_1476 &&
	...
	if (serial->dev->descriptor.idVendor == ZTE_VENDOR_ID &&
	serial->dev->descriptor.idProduct == OPTION_PRODUCT_ZTE_LTE_1509 &&
	serial->interface->cur_altsetting->desc. bInterfaceNumber == 4)
	{
		return -ENODEV;
	}
...
static int option_attach(struct usb_serial *serial)
{
	...
	if (!is_blacklisted(iface_desc->bInterfaceNumber,
		...
		data->use_send_setup = option_send_setup;
	}
